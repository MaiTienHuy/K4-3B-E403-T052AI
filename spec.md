...
- **Phân công có tên cụ thể (spec / evidence / prompt / code / demo)**:
  - **Mai Tiến Huy (Product & AI Spec)**: Chủ trì định hình bài toán, viết và hoàn thiện `spec.md`, chuẩn hóa cấu trúc Knowledge Base từ 6 transcript clean (`transcript-01` đến `transcript-06`), điều phối chung dự án.
  - **Hoàng Ngọc Đức (Evidence & Evaluation)**: Khai thác chatlog thực tế (13.494 lượt chat, phát hiện 42 case lỗi xuyên buổi), xây dựng Golden Set 20 case đa tầng kiểm thử (`eval/golden_set_cross_lecture.json`), thiết lập eval harness và đo lường các lượt chạy.
