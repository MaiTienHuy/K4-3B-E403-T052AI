...
**Lớp:** 3B · **Phòng:** E403 · **Cụm:** 2 · **Track:** A

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Mai Tiến Huy |02914  | Product & AI Spec | Định hình bài toán, viết và hoàn thiện `spec.md`, chuẩn hóa Knowledge Base và điều phối chung dự án. |
| Hoàng Ngọc Đức | 02380 | Evidence & Evaluation | Khai thác chatlog, xây dựng Golden Set 20 case, thiết lập eval harness và đo lường kết quả. |
| Trịnh Xuân Huy |02995  | Prompt & AI Router | Thiết kế prompt phân loại ý định, xây dựng Cross-lecture Router, xử lý G10/G11/G8/G9 và kiểm soát citation. |
| Lê Việt Hoàng |02596  | Code & Interactive Demo | Phát triển prototype Streamlit, mô phỏng các luồng trải nghiệm, chuẩn bị demo và phối hợp validation với willing users. |
...
├── codebase/          ← mã nguồn prototype có gọi AI thật (ghi rõ phần nào mock)
